  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <hr>
        <form method="POST" action="service_INP.php?action=change" autocomplete = "on">
            <table>
            <?php if ($errors) { ?>
            ...
            <?php } ?>
                ...
                <table>
                <tr><td>Название:</td>
                <td><input type="text" name="service_title" value="<?=htmlentities($default[0]->service_name)?>" required="required" maxlength="30">
                </td></tr>

                <tr><td>Цена за услугу:</td>
                <td><input type="number" name="cost" value="<?=htmlentities($default[0]->cost)?>" required="required" maxlength="10">
                </td></tr>

                <tr><td>Описание:</td>
                <td><textarea rows="10" cols="45" name="describe"><?=htmlentities($default[0]->service_describe)?></textarea>
                </td></tr>
              ...
              <input type="hidden" name="servId" value=<?= $default[0]->service_id?>>
        </form>
